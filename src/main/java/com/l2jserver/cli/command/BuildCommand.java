...
public class BuildCommand extends AbstractCommand {
	...
	public void run() {
		try {
			final var isWindows = System.getProperty("os.name").toLowerCase().startsWith("windows");
	...
	private void executeMavenWrapper(String goal, String sourceDir, Properties properties, boolean isWindows) throws Exception {
		final var mavenExecutableName = "mvnw" + (isWindows ? ".cmd" : "");
		final var mavenExecutableFile = new File(sourceDir, mavenExecutableName).getAbsoluteFile();
